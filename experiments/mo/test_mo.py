...
def run_test(n_runs, configs, objectives, objective_names, evals, xp_name, metrics_filename, pretrain=True):
    ...
    for obj_name in objective_names:
        ...
        plt.savefig(f'experiments/mo/plots/{xp_name}_{obj_name}.png', bbox_inches='tight')
...
def compare_pretrained_trained(n_runs, configs, objectives, objective_names, evals, xp_name, metrics_filename):
    ...
    for obj_name in objective_names:
        ...
        plt.legend(loc='lower right')
        plt.savefig(f'experiments/mo/plots/not_pretrained_vs_pretrained/{xp_name}_prVnpr_{obj_name}.png', bbox_inches='tight')
...
def compare_shared_training_2_experiments(n_runs, configs,
    ...
    for obj_name in common_objective_names:
        ...
        plt.legend(loc='lower right')
        plt.savefig(f'experiments/mo/plots/2v3_objectives/{xp_name}_{obj_name}.png', bbox_inches='tight')
...
if __name__ == '__main__':
    ...
    total_evals, n_runs = args.total_evals, args.runs

    create_dir_if_not_existing('experiments/mo/plots')
    create_dir_if_not_existing('experiments/mo/plots/not_pretrained_vs_pretrained')
    create_dir_if_not_existing('experiments/mo/plots/2v3_objectives')

    evals_filename = "experiments/mo/pretraining_data/hw_n201_cifar10_evals.pickle"
    metrics_filename = "experiments/mo/pretraining_data/hw_n201_cifar10_metrics.pickle"
